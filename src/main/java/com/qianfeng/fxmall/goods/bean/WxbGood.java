...
public class WxbGood implements Serializable {
  ...
  private String kfqq;
  private List<WxbGoodSku> wxbGoodSkus;

  public List<WxbGoodSku> getWxbGoodSkus() {
    return wxbGoodSkus;
  }

  public void setWxbGoodSkus(List<WxbGoodSku> wxbGoodSkus) {
    this.wxbGoodSkus = wxbGoodSkus;
  }

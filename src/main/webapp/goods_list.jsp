                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="sender" id="sample-table-2_info">
                                                共 ${pageCount} 条记录，每页 ${pageSize} 条，共 ${pageNO} 页
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                                    ...
                                                    <%--<li><a href="goods.do?page=2">2</a></li>--%>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${pageNo>1}">
                                                                <li>
                                                                    <a href="goods.do?pageNo=${pageNo-1}" aria-label="Previous">
                                                        ...
                                                        <c:forEach var="i" begin="1" end="${pageNO}">
                                                            <li><a href="goods.do?pageNo=${i}">${i}</a></li>
                                                        </c:forEach>
                                                        <!-- 下一页链接 -->
                                                        <c:choose>
                                                            <c:when test="${pageNo<pageNO}">
                                                                <li>
                                                                    <a href="goods.do?pageNo=${pageNo+1}" aria-label="Next">
